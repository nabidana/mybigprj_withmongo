...
public interface GameService {
    ...
    String modifytoGame(String gamename, String price, String discount, String sumnail, String category, String imagelink, String productCount);
    String minusProductCount(String gamename);
}
