...
public class UserRestController {
    ...
    @PostMapping("/modifyuser/get")
    public Map<String, String> getUserInfors(
        Principal principal
    ){
        return userinfoService.findmodifyUser(principal.getName());
    }

    @PutMapping("/modifyuser/modify")
    public String actionModifyUser(
        ...
        return userinfoService.changePassword(userid, userpw);
    }

    @PostMapping("/myitem/cartCount")
    public String getMyCartCounter(
        Principal principal
    )throws Exception{
        return userinfoService.myCartNumber(principal.getName());
    }
}
